...
all CONVERT () - formats 
- types of CONVERT () --> 
and all culture codes - used in FORMAT
*/

/*
Each format - in the number and date - is changing according to the Culture code

en - US , Europe , france , japan -- all countries have their culture codes and standards of representing the 
data in that specified format 
every country represents the - date format - in their style
